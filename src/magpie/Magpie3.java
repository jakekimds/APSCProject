...
public class Magpie3 {
	...
	public String getResponse(String statement) {
		...
		} else if (findKeyword(statement, "limerick") >= 0) {
			response = "A mosquito was heard to complain\nThat a chemist had poisoned his brain\nThe cause of his sorrow\nWas paradichloro\nDiphenyltrichloroethane.";
		} else if (findKeyword(statement, "lightsabers") >= 0) {
			response = "I like Star Wars too.";
		} else if (findKeyword(statement, "school") >= 0) {
			response = "School is boring.";
