...
public class DeckTesterBuggy1 {
	 ...
	 * 
	 * @param d
	 *            is a deck that should be empty.
	 */
	 ...
	 * 
	 * @param d
	 *            is a deck that should contain a single card.
	 * @param intended
	 *            is the card that the one-card deck should contain.
	 */
